...
[![CI](https://badges.reasonkit.sh/github/actions/workflow/status/reasonkit/reasonkit-web/ci.yml?branch=main&logo=github&label=CI&color=accent&logoColor=accent)](https://github.com/reasonkit/reasonkit-web/actions/workflows/ci.yml)
[![Security](https://badges.reasonkit.sh/github/actions/workflow/status/reasonkit/reasonkit-web/security.yml?branch=main&logo=github&label=Security&color=ok&logoColor=ok)](https://github.com/reasonkit/reasonkit-web/actions/workflows/security.yml)
[![Crates.io](https://badges.reasonkit.sh/crates/v/reasonkit-web?logo=rust&color=ok)](https://crates.io/crates/reasonkit-web)
[![docs.rs](https://badges.reasonkit.sh/docsrs/reasonkit-web?logo=docs.rs&color=accent)](https://docs.rs/reasonkit-web)
[![Downloads](https://badges.reasonkit.sh/crates/d/reasonkit-web?color=signal&logo=rust)](https://crates.io/crates/reasonkit-web)
[![License](https://badges.reasonkit.sh/static/v1?label=license&message=Apache%202.0&color=pro)](LICENSE)
